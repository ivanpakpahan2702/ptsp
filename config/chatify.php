...
return [
    ...
    |-------------------------------------
     */
    'name' => env('CHATIFY_NAME', 'PTSP Chat Room'),
     ...
     */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'chat-room'),
    ...
    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'chat-room/api'),
    ...
    'sounds' => [
        'enabled' => true,
        'public_path' => 'assets/chatify/sounds/chatify',

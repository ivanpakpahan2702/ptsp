...
<div class="messenger">
  ...
  <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
    ...
    <div class="m-header">
      ...
      {{-- Search input --}}
      <input type="text" class="messenger-search" placeholder="Pencarian" />
      {{-- Tabs --}}
    ...
    <div class="m-body contacts-container">
      ...
      <div class="show messenger-tab users-tab app-scroll" data-view="users">
        ...
        {{-- Saved Messages --}}
        <p class="messenger-title"><span>Ruang Privasi Anda</span></p>
        {!! view('Chatify::layouts.listItem', ['get' => 'saved']) !!}
        {{-- Contact --}}
        <p class="messenger-title"><span>Semua Chat</span></p>
      ...
      <div class="messenger-tab search-tab app-scroll" data-view="search">
        ...
        <div class="search-records">
          <p class="message-hint center-el"><span>Ketik Sesuatu Untuk Mencari..</span></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="messenger-messagingView">
    ...
    <div class="m-body messages-container app-scroll">
      <div class="messages">
        <p class="message-hint center-el"><span>Silahkan Pilih Kontak Yang Akan Dichat</span></p>
      </div>
      {{-- Typing indicator --}}

...
@if ($get == 'saved')
  <table class="messenger-list-item" data-contact="{{ Auth::user()->id }}">
    <tr data-action="0">
      ...
      {{-- center side --}}
      <td>
        <p data-id="{{ Auth::user()->id }}" data-type="user">Chat Yang Disimpan<span>Anda</span></p>
        <span>Simpan Chat Sebagai Konsep</span>
      </td>
    </tr>
  </table>
@endif
    ...
    <tr data-action="0">
      ...
      <td>
        ...
        <span>
          ...
          {!! $lastMessage->from_id == Auth::user()->id ? '<span class="lastMessageIndicator">Anda :</span>' : '' !!}
          {{-- Last message body --}}

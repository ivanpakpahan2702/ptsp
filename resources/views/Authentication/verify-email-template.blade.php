                                        ...
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            ...
                                            <p class="text-gray-800" style="line-height: 24px; font-size: 16px; color: #2d3748; width: 100%; margin: 0;" align="left">
                                              Akun anda berhasil terdaftar dan email anda harus diverifikasi. Silahkan tekan tombol <strong>"VERIFIKASI"</strong> di bawah ini untuk melanjutkan.<br>
                                              <strong><small>Apabila anda tidak pernah mendaftarkan akun anda menggunakan email ini, abaikan saja formulir ini.</small></strong>
                                            </p>
                                            <br>
                                            <div class="text-center" style="" align="center">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#198754">
                                                      <a href="{{ $url }}" target="_blank" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #198754; padding: 8px 12px; border: 1px solid #198754;">VERIFIKASI</a>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>

...
<body class="bg-success"
  ...
  bgcolor="#198754">
  <table class="bg-success body" valign="top" role="presentation" border="0" cellpadding="0" cellspacing="0"
    style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; margin: 0; padding: 0; border-width: 0;"
    bgcolor="#198754">
    <tbody>
      <tr>
                              ...
                              <tr>
                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left"
                                        ...
                                        <td
                                          ...
                                          <h1 class="h3  text-center"
                                            ...
                                            <div class="text-center" style="" align="center">
                                              <img src="https://i.ibb.co/6rjfmN5/icons8-law-96.png" class="logo"
                                                alt="PTSP Logo" width="35"
                                          ...
                                          <p class="text-gray-800"
                                            style="line-height: 24px; font-size: 16px; color: #2d3748; width: 100%; margin: 0;"
                                            align="left">
                                            Akun anda berhasil terdaftar dan
                                            email anda harus diverifikasi.
                                            Silahkan tekan tombol
                                            <strong>"VERIFIKASI"</strong> di
                                            bawah ini untuk melanjutkan.<br>
                                            <strong><small>Apabila anda
                                                tidak pernah
                                                mendaftarkan akun anda
                                                menggunakan email ini,
                                                abaikan saja formulir
                                                ini.</small></strong>
                                          </p>
                                          <br>
                                          <div class="text-center" style="" align="center">
                                            <table class="btn btn-success" role="presentation" border="0"
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td
                                                    ...
                                                    align="center" bgcolor="#198754">
                                                    <a href="{{ $url }}" target="_blank"
                                                      style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #198754; padding: 8px 12px; border: 1px solid #198754;">VERIFIKASI</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                          ...
                                          <small>Atau jika anda mengalami
                                            masalah ketika menekan tombol di
                                            atas, anda dapat menyalin link
                                            berikut, lalu jalankan pada url
                                            browser: </small>
                                          ...
                                          <p class="text-sm"
                                            style="line-height: 16.8px; font-size: 14px; width: 100%; margin: 0;"
                                            align="left">
                                            Salam<br>
                                            Admin PTSP Pengadilan Negeri
                                            Tais
                                          </p>
                                        </td>
                                      </tr>
                                  ...
                                  <div class="text-center" style="" align="center">
                                    Terima kasih
                                    <br>
                                    <a href="http://pn-tais.go.id"
                                      style="text-decoration: none; color: #0d6efd;">www.ptsp.pn-tais.go.id</a>
                                    <br>
                                    &#169;2024
                                  </div>
                                </td>

...
class MessagesController extends Controller
{
    ...
    {
        $user_now = Auth::user();
        $target_sender = User::find($request['id']);
        if ($user_now->id != $target_sender->id) {
            if ($user_now->role == 'Pengguna' and $target_sender->role == 'Pengguna') {
                abort(403);
            }
        }
    ...
    public function fetch(Request $request)
    {
        ...
        if ($totalMessages < 1) {
            $response['messages'] = '<p class="message-hint center-el"><span>Ketik \'Halo\' Dan Mulai Chat</span></p>';
    ...
    public function getContacts(Request $request)
    {
        ...
        if (count($usersList) > 0) {
            ...
            $contacts = '<small><p class="message-hint center-el"><span>Daftar Chat Anda Kosong, Silahkan Cari Kontak Admin (Contoh. Perdata,Pidana,Hukum,dll) Di Kolom Pencarian</span></p></small>';
        }
    ...
    public function search(Request $request)
    {
        ...
        if ($records->total() < 1) {
            $getRecords = '<p class="message-hint center-el"><span>Tidak Ada Yang Dapat Ditampilkan</span></p>';
        }
        // send the response
        return Response::json([
            'records' => $getRecords,
